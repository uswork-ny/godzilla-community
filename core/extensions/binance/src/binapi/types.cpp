...
/*************************************************************************************************/
/*************************************************************************************************/
leverage_info_t leverage_info_t::construct(const flatjson::fjson &json) {

    leverage_info_t res{};
    __BINAPI_GET(leverage);
    __BINAPI_GET(maxNotionalValue);
    __BINAPI_GET(symbol);

    return res;
}

std::ostream &operator<<(std::ostream &os, const leverage_info_t &o) {
    os
    << "{"
    << "\"symbol\":\"" << o.symbol << "\","
    << "\"leverage\":" << o.leverage << ","
    << "\"maxNotionalValue\":" << o.maxNotionalValue
    << "}";

    return os;
}

future_new_order_resp_t future_new_order_resp_t::construct(const flatjson::fjson &json) {
    future_new_order_resp_t res{};
...
std::ostream& operator<<(std::ostream &os, const future_new_order_resp_t &o) {
    (void)o;
    os << o.symbol << ", " << o.orderId;
    return os;
}

future_exchange_info_t future_exchange_info_t::construct(const flatjson::fjson &json) {
    future_exchange_info_t res{};
    res.configs = json.dump();
    return res;
}

std::ostream &operator<<(std::ostream &os, const future_exchange_info_t &o) {
    (void)o;
    return os;
}
    ...
    for ( auto idx = 0u; idx < symbols.size(); ++idx ) {
        ...
        for ( auto idx2 = 0u; idx2 < filters2.size(); ++idx2 ) {
            ...
            switch ( filter_hash ) {
                ...
                default: {
				 std::cout << filter.filterType << std::endl;
				//  assert("bad filterType" == nullptr);
			 }
            }
...
mark_price_t mark_price_t::construct(const flatjson::fjson &json) {
    assert(json.is_valid());
...
std::ostream& operator<<(std::ostream &os, const mark_price_t &o) {
    os
    << "{"
    << "\"s\": " << o.s << ","
    << "\"p\": \"" << o.p << "\","
...
future_order_update_t future_order_update_t::construct(const flatjson::fjson &json) {
    future_order_update_t res{};
    __BINAPI_GET(e);
    __BINAPI_GET(T);
    __BINAPI_GET(E);
    auto order = json.at("o");
    __BINAPI_GET2(res.o, s, order);
    __BINAPI_GET2(res.o, c, order);
    __BINAPI_GET2(res.o, S, order);
    __BINAPI_GET2(res.o, o, order);
    __BINAPI_GET2(res.o, f, order);
    __BINAPI_GET2(res.o, q, order);
    __BINAPI_GET2(res.o, p, order);
    __BINAPI_GET2(res.o, ap, order);
    __BINAPI_GET2(res.o, sp, order);
    __BINAPI_GET2(res.o, x, order);
    __BINAPI_GET2(res.o, X, order);
    __BINAPI_GET2(res.o, i, order);
    __BINAPI_GET2(res.o, l, order);
    __BINAPI_GET2(res.o, z, order);
    __BINAPI_GET2(res.o, L, order);
    __BINAPI_GET2(res.o, N, order);
    __BINAPI_GET2(res.o, n, order);
    __BINAPI_GET2(res.o, T, order);
    __BINAPI_GET2(res.o, t, order);
    __BINAPI_GET2(res.o, b, order);
    __BINAPI_GET2(res.o, a, order);
    __BINAPI_GET2(res.o, m, order);
    __BINAPI_GET2(res.o, R, order);
    __BINAPI_GET2(res.o, wt, order);
    __BINAPI_GET2(res.o, ot, order);
    __BINAPI_GET2(res.o, ps, order);
    __BINAPI_GET2(res.o, cp, order);
    // __BINAPI_GET2(res.o, AP, order);
    // __BINAPI_GET2(res.o, cr, order);
    __BINAPI_GET2(res.o, rp, order);
    return res;
}

std::ostream& operator<<(std::ostream &os, const future_order_update_t &o) {
    (void)o;
    os << o.o.s << ", " << o.o.i << ", ";
    os << o.o.n << ", " << o.o.N;
    return os;
