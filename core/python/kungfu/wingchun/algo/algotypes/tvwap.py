...
class TwapOrder(AlgoOrder):
    __params_schema__ = Schema({"source_id": str, "account_id": str, "symbol": str, "exchange_id": str, "volume": int, "duration_ns": int, "interval_ns": int},ignore_extra_keys=True)
    ...
    def on_schedule(self, ctx, idx):
        ...
        order_input.symbol = self.params["symbol"]
